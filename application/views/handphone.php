        ...
        <?php foreach ($handphone as $brg) : ?>
            ...
            <div class="card ml-4 mb-5" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <span onclick="return confirm('Ingin Melihat Produk ?')"><?php echo anchor('dashboard/detail/' . $brg->id_brg, '<div class="btn btn-sm btn-success" >More Info</div>') ?></span>
                </div>
            </div>
